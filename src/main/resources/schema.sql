...
alter table vocabulary add constraint vocabulary_fkey3 FOREIGN KEY (part_of_speech) REFERENCES parts_of_speech(id);
alter table vocabulary add constraint vocabulary_fkey4 FOREIGN KEY (user_id) REFERENCES users(id);
